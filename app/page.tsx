      ...
      <section className="container mx-auto px-4 pt-16 pb-24 md:pt-24 md:pb-32">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
            ...
            <span className="text-blue-600 dark:text-blue-400">AI answers</span>, not just search results
          </h1>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed max-w-3xl">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="flex gap-4 sm:gap-6 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">We gather everything about your brand</h3>
              ...
              <div className="flex gap-4 sm:gap-6 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">We add context AI models care about</h3>
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="flex gap-4 sm:gap-6 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">We run it through 7 different checks</h3>
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div className="flex gap-4 sm:gap-6 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-base sm:text-lg">You get a clear action plan</h3>
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
