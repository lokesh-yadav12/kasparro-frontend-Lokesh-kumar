          ...
          <section className="mb-16">
            ...
            <Card className="p-6">
              <div className="space-y-6 text-gray-600">
                <div>
                  <p className="font-semibold text-gray-900 mb-2">ChatGPT: 100M users in 2 months</p>
                  <p className="text-sm">Fastest product adoption ever. Not even close.</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 mb-2">Google added AI to search</p>
                  <p className="text-sm">SGE is rolling out. Even Google knows the old way is done.</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 mb-2">Perplexity: 500M+ queries per month</p>
                  <p className="text-sm">People are choosing AI-first search. It's not a trend, it's a migration.</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 mb-2">Your SEO metrics are lying to you</p>
