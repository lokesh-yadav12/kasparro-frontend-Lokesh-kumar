        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <Card className="p-6 bg-white dark:bg-gray-800">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Input Assembly</h3>
              ...
              <Card className="p-6 bg-white dark:bg-gray-800">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Context Packing</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-3">
              ...
              <Card className="p-6 bg-white dark:bg-gray-800">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Module Analysis & Output</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-3">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="p-6 bg-white dark:bg-gray-800">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Brand Assets</h3>
              ...
              <Card className="p-6 bg-white dark:bg-gray-800">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Technical Data</h3>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
              ...
              <Card className="p-6 bg-white dark:bg-gray-800">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Authority Signals</h3>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
              ...
              <Card className="p-6 bg-white dark:bg-gray-800">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Competitive Context</h3>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
          ...
          <section className="mb-16">
            ...
            <Card className="p-6 bg-white dark:bg-gray-800">
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Comprehensive Audit Reports</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Detailed analysis across 7 modules with scores, insights, and recommendations
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">AI Visibility Dashboard</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Competitive Intelligence</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="p-6 bg-gray-50 dark:bg-gray-800">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Traditional SEO Tools</h3>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
              ...
              <Card className="p-6 bg-gray-50 dark:bg-gray-800">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Kasparro (AI-SEO)</h3>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <Card className="p-6 mt-6 bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <strong className="text-gray-900 dark:text-white">The Key Difference:</strong> Traditional SEO optimizes for search engines to show your link. 
